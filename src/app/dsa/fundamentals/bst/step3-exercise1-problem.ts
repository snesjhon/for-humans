...
//
// Return an array containing every value in sorted order.
// Use the BST's left-street, sign, right-street walk.
// If the town is empty, return [].
//
// Example:
//   collectInOrder(sign(8, sign(3), sign(11))) → [3, 8, 11]
//   collectInOrder(null)                        → []
