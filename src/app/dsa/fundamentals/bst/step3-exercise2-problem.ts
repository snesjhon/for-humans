...
//
// Return the values in ascending order whose addresses are between low and high.
// Use BST pruning to skip roads that are entirely too small or too large.
// If no address is in range, return [].
//
// Example:
//   collectAddressesInRange(sign(8, sign(3), sign(11)), 4, 10) → [8]
//   collectAddressesInRange(sign(8, sign(3), sign(11)), 12, 20) → []
