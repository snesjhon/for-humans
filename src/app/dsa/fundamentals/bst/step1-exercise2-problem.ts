...
//
// Return the number of nodes visited while searching for target.
// Count every sign the clerk stands on.
// If the search falls into an empty lot, return the count accumulated so far.
//
// Example:
//   countVisitedSigns(sign(8, sign(3), sign(11)), 11) → 2
//   countVisitedSigns(sign(8, sign(3), sign(11)), 7)  → 2
