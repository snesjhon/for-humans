...
//
// Return the floor of target in the BST.
// The floor is the largest value <= target.
// If no such sign exists, return null.
//
// Example:
//   findFloorAddress(sign(8, sign(3), sign(11)), 10) → 8
//   findFloorAddress(sign(8, sign(3), sign(11)), 2)  → null
