// Goal: Solve Fibonacci with the core recursion pattern: base cases first,
// then return the sum of the two smaller calls.
...
runTest('upper-range intro check: fib(10) = 55', () => fib(10), 55);
// ---End Tests
