...
export function scoreEditionReadiness(
  ...
  let totalCost = 0;
  // TODO: Declare a structure to track which required category IDs have been covered
  ...
  for (const pkg of packages) {
    ...
    // TODO: Record which required category IDs this package covers
  }

  // TODO: Compute coverage as a percentage of required categories that were covered
  return { totalCost, coverage: 0 };
}
