...
export function useSearchableList(items: CatalogItem[]): SearchableListView {
  // TODO: Keep the current search query in state
  // TODO: Normalize the query so casing and surrounding whitespace do not affect matching
  // TODO: Derive visibleItems from items and the normalized query
  return {
    query: '',
    visibleItems: items,
    setQuery: () => {},
