...
// TODO: choose the primitive that matches the job.
// - app-shell: two-dimensional page placement
// - device-card-grid: responsive two-dimensional card placement
// - card-header-row: title on one side, badge on the other
// - filter-toolbar-row: controls aligned along one row
