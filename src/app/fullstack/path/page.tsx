...
export default async function PathPage() {
  ...
  return (
    <>
      <PageHero>
        <h1 className="text-5xl font-bold leading-tight text-[var(--ms-text-body)]">The Path</h1>
                                ...
                                return (
                                  <div key={`r-${slug}`} className="flex items-center gap-1 py-[5px]">
                                    ...
                                    <Link
                                      ...
                                      className={`${pathStyles.problemLink} flex items-baseline`}
                                    >
                                      <span className="text-xs shrink-0 w-5 leading-none text-[var(--ms-peach)]">↩</span>
