export function VisualERTriage() {
  ...
  return (
    <div className="pt-[22px] px-[14px] pb-[14px] flex flex-col items-center gap-[7px] w-full">
      ...
      <div className="font-[ui-monospace,monospace] text-[0.52rem] text-[var(--ms-text-faint)] mb-[2px]">
          ...
          {row.map((n, c) => (
            <div
              ...
              style={{
                ...
                borderRadius: 6,
                background: r === 0 ? 'var(--ms-red-surface)' : 'var(--ms-bg-pane-secondary)',
      ...
      <div className="font-[ui-monospace,monospace] text-[0.54rem] text-[var(--ms-text-faint)] mt-[4px] text-center leading-[1.6]">
        parent ≤ children
        <br />
