    ...
    <div className="pt-[14px] px-[16px] pb-[10px] font-[ui-monospace,monospace] text-[0.72rem]">
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-[6px]">
          <span className="text-[var(--ctp-text-faint)] text-[0.6rem]">
            start
          </span>
          <span className="text-[var(--ctp-text-body)] font-semibold">{`""`}</span>
          <span className="text-[var(--ctp-text-faint)] text-[0.55rem]">
            open=2, close=2
          </span>
        </div>
        <div className="flex flex-col gap-[3px] pl-[12px]">
          <div className="flex items-center gap-[5px]">
            ...
            <span className="text-[var(--ctp-text-faint)] text-[0.52rem]">
              open=1
            </span>
          </div>
          <div className="flex flex-col gap-[3px] pl-[16px]">
            ...
            <div className="flex items-center gap-[5px]">
              ...
              <span className="text-[var(--ctp-blue)] font-bold">{`"()"`}</span>
              <span className="text-[var(--ctp-text-faint)] text-[0.52rem]">
                → "()()"{' '}
              </span>
              <span className="text-[#52b87a] text-[0.52rem]">✓</span>
      ...
      <div className="mt-[8px] text-[0.56rem] text-[var(--ctp-text-faint)]">
