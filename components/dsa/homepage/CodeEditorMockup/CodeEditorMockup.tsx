  ...
  return (
    <div className="border border-[rgba(255,255,255,0.07)] rounded-[0.875rem] overflow-hidden bg-[#1E1B2E] shadow-[0_8px_32px_rgba(0,0,0,0.24)] font-[ui-monospace,monospace] text-[0.78rem] leading-[1.7]">
      ...
      >
        ...
        <button className="py-[6px] px-[14px] rounded-[5px] bg-[var(--primary)] text-white border-0 text-[0.72rem] font-semibold cursor-pointer flex items-center gap-[6px] font-[ui-monospace,monospace]">
          Run{' '}
