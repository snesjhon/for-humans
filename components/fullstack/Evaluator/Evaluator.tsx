...
export default function Evaluator({
  ...
  return (
    <div className="border-b border-b-[var(--border)] pb-6">
      ...
      {question && (
        <div
          className="py-4 px-5 rounded-xl mb-4 bg-[var(--primary-tint)] border border-[var(--primary)]"
        >
      ...
      <button
        ...
        className="py-[8px] px-[20px] rounded-[6px] bg-[var(--primary)] text-white text-sm font-semibold border-0 cursor-pointer"
      >
        Discuss it →
      </button>
